...
6. optional - The default location of where the vbios will be dumped is in the isos share n a folder called vbios. You can change this by changing the variable vbioslocation="/mnt/user/isos/vbios/" to the location of your choosing.
